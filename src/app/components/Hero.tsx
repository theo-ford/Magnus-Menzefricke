...
export default function Hero({ pageData }) {
  return (
    <>
      <div className="bg-[#e34234] float-left relative w-[100vw] xl:w-[calc(75vw+0px)] xl:mr-[-30px] h-[100vh] scroll-section">
        <div className="m-[21px] w-[calc(100vw-44px)] xl:m-[30px] xl:mr[0px] xl:w-[calc(75vw-15px)]">
          <div className="h-[calc(100vh-44px)] xl:h-[calc(100vh-60px)] mt-[21px] absolute top-[0] z-50 xl:w-[calc(75vw-15px)] xl:mt-[25px]">
