...
export default function Grid16() {
  return (
    <>
      ...
      <div className="h-[auto] w-[calc(100vw-39.5px)]  opacity-[.6] xl:w-[calc(100%)] md:h-[calc(100vh-67px)] xl:h-[calc(100vh-60px)]">
        ...
        <div className="w-[calc(100%-10px)] border-t-[1px] border-[#d6d6d6] float-left relative  xl:hidden mb-[25px]"></div>
      </div>
    </>
  );
}
