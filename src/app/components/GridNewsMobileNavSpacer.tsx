...
export default function GridNewsMobileNavSpacer() {
  return (
    <>
      ...
      <div className="h-[calc(8.33vh)] w-[calc(100vw-26px)]  opacity-[.6] xl:w-[calc(25vw)] ml-[12.5px] mt-[15px] xl:h-[calc(100vh-20px)] xl:hidden">
        <div className="w-[calc(100%)] border-t-[1px] border-[#d6d6d6] float-left relative xl:w-[calc(100%)]"></div>
        <div className="w-[calc(100%)] h-[calc((100%)-1px)] float-left grid grid-cols-4 relative gap-[12.5px] xl:h-[calc((100%/8)-1px)] xl:w-[calc(100%)]">
