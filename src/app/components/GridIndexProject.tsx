...
export default function GridIndexProject() {
  return (
    <>
      ...
      <div className="h-[calc(8.33vh)] w-[100%]  opacity-[.3] xl:w-[calc(100%)] xl:h-[calc(8.33vh)]">
        <div className="w-[calc(100%)] border-t-[1px] border-[#d6d6d6] float-left relative xl:w-[calc(100%)]"></div>
        <div className="w-[calc(100%)] h-[calc((100%)-1px)] float-left grid grid-cols-4 relative gap-[10px] xl:h-[calc(100%)] xl:grid-cols-16 xl:w-[calc(100%)]">
