  ...
  return (
    <>
      {slice.variation == "1XLandscapeImage" && (
        <div className="h-[calc(100vh-72px)] w-[100%-108px] m-[36px]">
          <div className=" w-[calc(100%)] h-[calc(100%)] float-left grid grid-cols-4 grid-rows-12 relative gap-x-[15px] gap-y-[0px] xl:grid-cols-12 xl:grid-rows-8 xl:w-[calc(75vw-36px)]">
      ...
      {slice.variation == "2XLandscapeImage" && (
        <div className="h-[calc(100vh-72px)] w-[100%-36px] m-[36px]">
          <div className="w-[calc(100%-20px)] h-[calc(100%)] float-left grid grid-cols-4 grid-rows-12 relative gap-x-[15px] gap-y-[0px] xl:grid-cols-12 xl:grid-rows-8 xl:w-[calc(75vw-36px)] ">
            {slice.primary.position == "Left" ? (
              <>
      ...
      {slice.variation == "fullBleedImage" && (
        <div className="h-[calc(100vh-72px)] w-[100%-36px] m-[36px]">
          <div className="w-[calc(100%)] h-[calc(100%-10px)] float-left grid grid-cols-4 grid-rows-12 relative gap-x-[15px] gap-y-[0px] xl:grid-cols-12 xl:grid-rows-8 xl:h-[calc(100%+36px)]">
