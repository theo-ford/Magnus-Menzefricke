  ...
  return (
    <>
      {slice.variation == "1XLandscapeImage" && (
        ...
        <div className="w-[100%] h-[calc(100vh-44px)] xl:h-[calc(100vh-63px)] xl:w-[calc(100%-1.5px)] xl:mt-[1px]">
          ...
          <div className="w-[calc(100%)] xl:w-[calc(100%)] h-[calc(100vh-44px)] xl:h-[calc(100vh-63px)] float-left grid grid-cols-4 grid-rows-12 relative gap-x-[12.5px] xl:gap-x-[17px] gap-y-[1px] xl:grid-cols-12 xl:grid-rows-8 xl:w-[calc(75vw-15px)]">
