  ...
  return (
    <>
      {slice.variation == "1XLandscapeImage" && (
        <div className="w-[100%] h-[calc(100vh-63px)] m-[30px] xl:h-[calc(100vh-62px)] xl:w-[calc(75vw-30px)]">
          <div className="w-[calc(100%-30px)] h-[calc(100%)] float-left grid grid-cols-4 grid-rows-12 relative gap-x-[15px] gap-y-[0px] xl:grid-cols-12 xl:grid-rows-8 xl:w-[calc(75vw-45px)]">
      ...
      {slice.variation == "fullBleedImage" && (
        <div className="w-[100%] h-[calc(100vh-63px)] m-[30px] xl:h-[calc(100vh-62px)] xl:w-[calc(75vw-30px)]">
          <div className="w-[calc(100%-30px)] h-[calc(100%-10px)] float-left grid grid-cols-4 grid-rows-12 relative gap-x-[15px] gap-y-[0px] xl:grid-cols-12 xl:grid-rows-8 xl:h-[calc(100%+45px)]">
