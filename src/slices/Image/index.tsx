    ...
    <>
      {slice.variation == "1XLandscapeImage" && (
        ...
        <div className="h-[calc(100vh-52px)] xl:h-[calc(100vh-63px)] w-[calc(100%-2px)] xl:w-[calc(100%-1.5px)] xl:mt-[0px]">
          ...
          <div className="w-[calc(100%)] xl:w-[calc(100%)] h-[calc(100vh-28px)] xl:h-[calc(100vh-6.2vh)] float-left grid grid-cols-4 grid-rows-12 relative gap-x-[13.5px] xl:gap-x-[17px] gap-y-[2px] xl:grid-cols-12 xl:grid-rows-8 xl:w-[calc(75vw-15px)]">
