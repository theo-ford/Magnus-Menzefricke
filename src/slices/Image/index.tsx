    ...
    <>
      {slice.variation == "1XLandscapeImage" && (
        <div className="h-[calc(100vh-50px)] xl:h-[calc(100vh-60px)] w-[calc(100%)] xl:w-[calc(100%)] xl:mt-[0px]">
          <div className="w-[calc(100%)] xl:w-[calc(100%-2px)] h-[calc(100vh-4px)] xl:h-[calc(100%)] float-left grid grid-cols-4 grid-rows-12 relative gap-x-[10px] xl:gap-x-[15px] gap-y-[2px] xl:grid-cols-12 xl:grid-rows-8 xl:w-[calc(75vw-15px)]">
      ...
      {slice.variation == "2XLandscapeImage" && (
        ...
        // <div className="w-[calc(100%)] xl:w-[calc(100%)] h-[calc(100vh-28px)] xl:h-[calc(100vh-63px)] float-left grid grid-cols-4 grid-rows-12 relative gap-x-[11.5px] xl:gap-x-[15px] gap-y-[2px] xl:grid-cols-12 xl:grid-rows-8 xl:w-[calc(75vw-15px)]">
        <div className="h-[calc(100vh-50px)] xl:h-[calc(100vh-60px)] w-[calc(100%)] xl:w-[calc(100%)] xl:mt-[0px]">
          <div className="w-[calc(100%)] xl:w-[calc(100%-2px)] h-[calc(100vh-4px)] xl:h-[calc(100%)] float-left grid grid-cols-4 grid-rows-12 relative gap-x-[10px] xl:gap-x-[15px] gap-y-[2px] xl:grid-cols-12 xl:grid-rows-8 xl:w-[calc(75vw-15px)]">
            {slice.primary.position == "Left" ? (
              <>
      ...
      {slice.variation == "2XPortraitImage" && (
        ...
        //   <div className="w-[calc(100%)] xl:w-[calc(100%)] h-[calc(100vh-28px)] xl:h-[calc(100vh-63px)] float-left grid grid-cols-4 grid-rows-12 relative gap-x-[10px] xl:gap-x-[15px] gap-y-[2px] xl:grid-cols-12 xl:grid-rows-8 xl:w-[calc(75vw-15px)]">
        <div className="h-[calc(100vh-50px)] xl:h-[calc(100vh-60px)] w-[calc(100%)] xl:w-[calc(100%)] xl:mt-[0px]">
          <div className="w-[calc(100%)] xl:w-[calc(100%-2px)] h-[calc(100vh-4px)] xl:h-[calc(100%)] float-left grid grid-cols-4 grid-rows-12 relative gap-x-[10px] xl:gap-x-[15px] gap-y-[2px] xl:grid-cols-12 xl:grid-rows-8 xl:w-[calc(75vw-15px)]">
