    ...
    <>
      {slice.variation == "1XLandscapeImage" && (
        ...
        <div className=" h-[calc(100vh-52px)] xl:h-[calc(100vh-63px)] w-[calc(100%-2px)] xl:w-[calc(100%-1.5px)] xl:mt-[0px]">
          {/* <div className="w-[calc(100%-22px)] xl:w-[calc(75vw-15px)] h-[calc(100vh-44px)] xl:h-[calc(100vh-60px)] float-left grid grid-cols-4 grid-rows-12 relative gap-x-[9px] xl:gap-x-[15px] gap-y-[0px] xl:grid-cols-12 xl:grid-rows-8 xl:w-[calc(75vw-15px)]"> */}
          {/* <div className="w-[calc(100%)] xl:w-[calc(100%)] h-[calc(100vh-44px)] xl:h-[calc(100vh-60px)] float-left grid grid-cols-4 grid-rows-12 relative gap-x-[9px] xl:gap-x-[15px] gap-y-[0px] xl:grid-cols-12 xl:grid-rows-8 xl:w-[calc(75vw-15px)]"> */}
          {/* <div className="w-[calc(100%)] xl:w-[calc(100%)] h-[calc(100vh-44px)] xl:h-[calc(100vh-63px)] float-left grid grid-cols-4 grid-rows-12 relative gap-x-[9px] xl:gap-x-[17px] gap-y-[2px] xl:grid-cols-12 xl:grid-rows-8 xl:w-[calc(75vw-15px)]"> */}
          <div className="w-[calc(100%)] xl:w-[calc(100%)] h-[calc(100vh-52px)] xl:h-[calc(100vh-63px)] float-left grid grid-cols-4 grid-rows-12 relative gap-x-[9px] xl:gap-x-[17px] gap-y-[2px] xl:grid-cols-12 xl:grid-rows-8 xl:w-[calc(75vw-15px)]">
      ...
      {/* {slice.variation == "fullBleedImage" && (
        <div className="w-[100%] h-[calc(100vh-44px)] m-[0px] xl:mt-[0px] xl:h-[calc(100vh-60px)] overflow-hidden xl:w-[calc(75vw)]">
          <div className="w-[calc(100%)] h-[calc(100%-0px)] xl:h-[calc(100%+0px)] float-left grid grid-cols-4 grid-rows-12 relative gap-x-[9px] xl:gap-x-[15px] gap-y-[0px] xl:grid-cols-12 xl:grid-rows-8 ">
