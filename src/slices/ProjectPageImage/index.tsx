      ...
      <div className="mt-[16.66vh] xl:mt-[12.5vh] float-left relative w-[100%]">
        {slice.variation == "1XLandscapeImage" && (
          <>
            ...
            <div className="h-auto w-[100%] mt-[6px]  m-[11px] xl:m-[30px] xl:h-auto xl:mt-[10px] absolute">
        ...
        {slice.variation == "1XPortraitImage" && (
          <>
            <div className="w-[100%] h-[calc(66.65vh-20px)]   m-[11px] xl:m-[30px]  md:h-[calc(62.5vh-20px)] min-h-[40px] md:min-h-[400px] xl:min-h-[400px]">
              <div className="w-[calc(100%)] h-[calc(100%)] float-left grid grid-cols-4 grid-rows-8 relative gap-x-[11px] xl:gap-x-[15px] gap-y-[0px] md:grid-cols-16 md:grid-rows-5 md:w-[100%] ">
                {slice.primary.position == "Left" ? (
            ...
            <div className="h-auto w-[100%] mt-[-6px]  ml-[11px] xl:ml-[30px]  xl:h-auto xl:mt-[-20px] absolute">
        ...
        {slice.variation == "2XLandscapeImage" && (
          <>
            <div className="h-[calc(16.66vh-20px)] md:h-[calc(25vh-20px)] w-[100%]  m-[11px] xl:m-[30px]  xl:h-[calc(25vh-20px)]">
              <div className="w-[calc(100%)] h-[calc(100%)] float-left grid grid-cols-4 grid-rows-2 md:!grid-rows-3 relative gap-x-[11px] xl:gap-x-[15px] gap-y-[0px] xl:grid-cols-16 xl:grid-rows-2  min-h-[75px] md:!min-h-[200px] xl:min-h-[250px]">
                {slice.primary.position == "Left" ? (
                  <>
            ...
            <div className="h-auto w-[calc(100%)] mt-[-6px]  ml-[11px] xl:m-[30px]  xl:h-auto xl:mt-[-20px] absolute">
        ...
        {slice.variation == "2XPortraitImage" && (
          <>
            <div className="w-[100%] mt-[-4px] m-[11px] xl:m-[30px] h-[calc(33.32vh-20px)]  md:h-[calc(62.5vh-20px)] xl:h-[calc(62.5vh-20px)] min-h-[40px] md:min-h-[400px] xl:min-h-[400px]">
              <div className="w-[100%] h-[calc(100%)] float-left grid grid-cols-4 grid-rows-10 relative gap-x-[11px] xl:gap-x-[15px] gap-y-[0px] md:grid-rows-5 xl:grid-cols-16 xl:grid-rows-5 ">
                {slice.primary.position == "Left" ? (
                  <>
            ...
            <div className="h-auto w-[100%] mt-[-6px] ml-[11px] xl:ml-[30px]  xl:h-auto xl:mt-[-20px] absolute">
              <div className="float-left w-[100%] grid grid-cols-4 grid-rows-1 relative gap-x-[11px] xl:gap-x-[15px] gap-y-[0px] xl:grid-cols-16 ">
                {slice.primary.position == "Left" ? (
                  <div className="col-span-4 col-start-1 row-start-1 row-span-1 xl:col-span-8 xl:col-start-1 flex items-center">
                    <p className="leading-none m-[0] p-[0] text-[12px] xl:text-[12px]">
                      {slice.primary.caption_1 &&
